...
function pubJoystick(gamepadData) {
	...
	joy_msg.axes[2] = gamepadData.axes[3]; // Right stick X
	joy_msg.axes[3/*4*/] = gamepadData.axes[4]; // Right stick Y

	joy_msg.axes[4/*2*/] = gamepadData.buttons[2].value; // Left trigger
	joy_msg.axes[5] = gamepadData.buttons[5].value; // Right trigger
